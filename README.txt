Boulders mod Copyright (c) 2024 Neuromancer
...
This mod adds boulders which are found in dirt and stone.  When they fall they cause sigificant harm to the player.   You can craft them into stone and vice versa.   You could try creating traps to drop boulders on mobs or other players.  You can use the dirt_tunneler mod to find them more quickly.
...
At some point I plan on attempting to add more mechanics, like being able to push/roll boulders, and if a boulder winds up on top of another boulder it will roll off to the side.
